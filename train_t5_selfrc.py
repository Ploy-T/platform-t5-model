...
if __name__ == '__main__':
    ...
    train_set = _data['train']
    validation_set = _data['validation']

    train_set = Dataset.from_dict(train_set[:20])
    validation_set = Dataset.from_dict(validation_set[:5])
    ...
    validation_set = DataSet(
        validation_set, tokenizer, parser=MyDataset.DatasetMap.squad)
